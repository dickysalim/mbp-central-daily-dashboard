...
const ALL_COLUMNS: ColDef[] = [
  ...
  { id: 'r_rl_share_cc',   label: 'RL Share CC',       get: r => safeDiv(r.rl_ccom, rlAll(r)),              fmt: fmtPct,  brands: ['MNC','GOL'],       group: 'ratios' },
  { id: 'r_rl_share_dp',   label: 'RL Share DP',       get: r => safeDiv(r.rl_d2or, rlAll(r)),              fmt: fmtPct,  brands: ['MNC','GOL'],       group: 'ratios' },
  { id: 'r_rl_share_mp',   label: 'RL Share MP',       get: r => safeDiv(r.rl_mpsh, rlAll(r)),              fmt: fmtPct,  brands: ['MNC','GOL'],       group: 'ratios' },
  { id: 'r_rl_share_os',   label: 'RL Share OS',       get: r => safeDiv(r.rl_ofls, rlAll(r)),              fmt: fmtPct,  brands: ['MNC','GOL'],       group: 'ratios' },
  ...
  { id: 'r_cpr',           label: 'CPR',               get: r => safeDiv(r.ad_spend, r.form_submission),    fmt: fmtRpD,  brands: ['MCI'],             group: 'ratios' },
  { id: 'r_cpv',           label: 'CPV',               get: r => safeDiv(r.ad_spend, r.visit),              fmt: fmtRpD,  brands: ['MCI'],             group: 'ratios' },
